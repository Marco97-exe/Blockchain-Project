...
const ServiceCard = ({color, title, icons, subtitle}) => (
    <div className="flex flex-row justify-start items-center white-glassmorphism p-3 m-2 cursor-pointer hover:shadow-xl">
        ...
        <div className="ml-5 flex flex-col felx-1">
        ...
        <div className="flex  flex-col  md:flex-row w-full justify-center items-center gradient-bg-services">
            ...
            <div className="flex-1 flex flex-col justify-start items-center">
                <ServiceCard
                    ...
                    subtitle="Security is guaranteed. We always maintain privacy and maintain quality"
                />
                <ServiceCard
                    color="bg-[#8945f58]"
                    title="Best Prenotation Site EVER"
                    icons={<BiSearchAlt fontSize={21} className="text-white"/>}
                    subtitle="Security is guaranteed. We always maintain privacy and maintain quality"
                />
                <ServiceCard
                    color="bg-[#f84550]"
                    title="Fast Prenotation"
